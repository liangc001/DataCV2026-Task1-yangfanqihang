...
export VQA_JUDGE_MODEL="${VQA_JUDGE_MODEL_D:-gpt-5.1}"
export VQA_FALLBACK_MODEL="${VQA_FALLBACK_MODEL_D:-gpt-5.1}"
export VQA_V8_CHALLENGE_ENABLE="${VQA_V8_CHALLENGE_ENABLE:-0}"
