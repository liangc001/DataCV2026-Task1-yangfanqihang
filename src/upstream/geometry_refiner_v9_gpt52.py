    ...
    def run(self, output_txt: str, output_json: str) -> None:
        ...
        info = {
            ...
            "parameters": {
                ...
                "pipeline": "base predictions with dedicated v9 geometry verifier refiner for line/alignment/boundary prompts",
            },
        }
...
def main() -> None:
    ap = argparse.ArgumentParser(
        description="Refine geometry-heavy questions over base predictions using the compliant v9 verifier."
    )
    ...
    GeometryRefiner(base_predictions, args.input_csv).run(args.output_txt, args.output_json)
