...
export VQA_JUDGE_MODEL="${VQA_JUDGE_MODEL_L:-gpt-5.2}"
export VQA_FALLBACK_MODEL="${VQA_FALLBACK_MODEL_L:-gpt-5.1}"
export VQA_V8_CHALLENGE_ENABLE="${VQA_V8_CHALLENGE_ENABLE:-1}"
export VQA_V8_STRICT_CHALLENGE="${VQA_V8_STRICT_CHALLENGE:-0}"
export VQA_V8_INCLUDE_RAW_ALWAYS="${VQA_V8_INCLUDE_RAW_ALWAYS:-0}"
